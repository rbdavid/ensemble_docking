...
export OUTPUT_DIR="new_box/AAA"
export SLURM_SUBMIT_DIR="/lustre/or-scratch/cades-bsd/davidsonrb"
...
# noncovalent docking
if [ -f AAA_nc.trg ]; then
	echo already made AAA_nc.trg file
else
	$ADFR_HOME/agfr -r AAA.pdbqt -o AAA_nc -b user 44.0 31.5 -1.0 28.0 23.0 34.0 -s 0.25 
fi
# covalent docking
if [ -f AAA_c.trg ]; then
	echo already made AAA_c.trg file
else
	$ADFR_HOME/agfr -r AAA.pdbqt -o AAA_c  -b user 44.0 31.5 -1.0 28.0 23.0 34.0 -s 0.25 -c 1091 1094 -t 1090 -x A:CYS111
fi
